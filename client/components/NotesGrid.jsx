...
class NotesGrid extends React.Component {
	...
	render() {
		...
		let notesAfterDeveloperFilter =
			developerFilter !== 'All'
				? notesList.filter(elem => elem.developer === developerFilter)
				: notesList;
		let notesAfterProjectFilter =
			projectFilter !== 'All'
				? notesAfterDeveloperFilter.filter(
						elem => elem.project === projectFilter
				  )
				: notesAfterDeveloperFilter;
		return (
			<div className="content">
				...
				{this.props.modal._id ? (
					<ModalWindow modalDate={this.props.modal} />
				) : null}
			</div>
		);
	}
